...
import jakarta.persistence.Table;
	...
	public class BankNiftyCompaniesData {

		 private static BankNiftyCompaniesData instance;
		...
		private Double 	highestOptChainVol_open;
	    ...
	    private Double 	highestOptChainVol_highPriceRange;
	    private Long 	highestOptChainVol_volume;
	    private Double 	highestOptChainVol_lowTradeRange;
	    private Double 	highestOptChainVol_highTradeRange;
	    private Long 	highestOptChainVol_totalBuyQty;
	    private Long 	highestOptChainVol_totalSellQty;
	    private Double 	highestOptChainVol_openInterest;
	    private Double 	highestOptChainVol_prevOpenInterest;
	    private Double 	highestOptChainVol_oiDayChange;
	    private Double 	highestOptChainVol_oiDayChangePerc;
	    private Long 	highestOptChainVol_lastTradeQty;
	    private Long 	highestOptChainVol_lastTradeTime;
	    private String 	highestOptChainVol_type;
		...
		public static void setInstance(BankNiftyCompaniesData instance) {
			BankNiftyCompaniesData.instance = instance;
		}
		public Long getId() {
			return id;
		}
		...
		public Double getHighestOptChainVol_open() {
			return highestOptChainVol_open;
		}
		public void setHighestOptChainVol_open(Double highestOptChainVol_open) {
			this.highestOptChainVol_open = highestOptChainVol_open;
		}
		public Double getHighestOptChainVol_high() {
			return highestOptChainVol_high;
		}
		public void setHighestOptChainVol_high(Double highestOptChainVol_high) {
			this.highestOptChainVol_high = highestOptChainVol_high;
		}
		public Double getHighestOptChainVol_low() {
			return highestOptChainVol_low;
		}
		public void setHighestOptChainVol_low(Double highestOptChainVol_low) {
			this.highestOptChainVol_low = highestOptChainVol_low;
		}
		public Double getHighestOptChainVol_close() {
			return highestOptChainVol_close;
		}
		public void setHighestOptChainVol_close(Double highestOptChainVol_close) {
			this.highestOptChainVol_close = highestOptChainVol_close;
		}
		public Double getHighestOptChainVol_ltp() {
			return highestOptChainVol_ltp;
		}
		public void setHighestOptChainVol_ltp(Double highestOptChainVol_ltp) {
			this.highestOptChainVol_ltp = highestOptChainVol_ltp;
		}
		public Double getHighestOptChainVol_dayChange() {
			return highestOptChainVol_dayChange;
		}
		public void setHighestOptChainVol_dayChange(Double highestOptChainVol_dayChange) {
			this.highestOptChainVol_dayChange = highestOptChainVol_dayChange;
		}
		public Double getHighestOptChainVol_dayChangePerc() {
			return highestOptChainVol_dayChangePerc;
		}
		public void setHighestOptChainVol_dayChangePerc(Double highestOptChainVol_dayChangePerc) {
			this.highestOptChainVol_dayChangePerc = highestOptChainVol_dayChangePerc;
		}
		public Double getHighestOptChainVol_lowPriceRange() {
			return highestOptChainVol_lowPriceRange;
		}
		public void setHighestOptChainVol_lowPriceRange(Double highestOptChainVol_lowPriceRange) {
			this.highestOptChainVol_lowPriceRange = highestOptChainVol_lowPriceRange;
		}
		public Double getHighestOptChainVol_highPriceRange() {
			return highestOptChainVol_highPriceRange;
		}
		public void setHighestOptChainVol_highPriceRange(Double highestOptChainVol_highPriceRange) {
			this.highestOptChainVol_highPriceRange = highestOptChainVol_highPriceRange;
		}
		public Long getHighestOptChainVol_volume() {
			return highestOptChainVol_volume;
		}
		public void setHighestOptChainVol_volume(Long highestOptChainVol_volume) {
			this.highestOptChainVol_volume = highestOptChainVol_volume;
		}
		public Double getHighestOptChainVol_lowTradeRange() {
			return highestOptChainVol_lowTradeRange;
		}
		public void setHighestOptChainVol_lowTradeRange(Double highestOptChainVol_lowTradeRange) {
			this.highestOptChainVol_lowTradeRange = highestOptChainVol_lowTradeRange;
		}
		public Double getHighestOptChainVol_highTradeRange() {
			return highestOptChainVol_highTradeRange;
		}
		public void setHighestOptChainVol_highTradeRange(Double highestOptChainVol_highTradeRange) {
			this.highestOptChainVol_highTradeRange = highestOptChainVol_highTradeRange;
		}
		public Long getHighestOptChainVol_totalBuyQty() {
			return highestOptChainVol_totalBuyQty;
		}
		public void setHighestOptChainVol_totalBuyQty(Long highestOptChainVol_totalBuyQty) {
			this.highestOptChainVol_totalBuyQty = highestOptChainVol_totalBuyQty;
		}
		public Long getHighestOptChainVol_totalSellQty() {
			return highestOptChainVol_totalSellQty;
		}
		public void setHighestOptChainVol_totalSellQty(Long highestOptChainVol_totalSellQty) {
			this.highestOptChainVol_totalSellQty = highestOptChainVol_totalSellQty;
		}
		public Double getHighestOptChainVol_openInterest() {
			return highestOptChainVol_openInterest;
		}
		public void setHighestOptChainVol_openInterest(Double double1) {
			this.highestOptChainVol_openInterest = double1;
		}
		public Double getHighestOptChainVol_prevOpenInterest() {
			return highestOptChainVol_prevOpenInterest;
		}
		public void setHighestOptChainVol_prevOpenInterest(Double double1) {
			this.highestOptChainVol_prevOpenInterest = double1;
		}
		public Double getHighestOptChainVol_oiDayChange() {
			return highestOptChainVol_oiDayChange;
		}
		public void setHighestOptChainVol_oiDayChange(Double highestOptChainVol_oiDayChange) {
			this.highestOptChainVol_oiDayChange = highestOptChainVol_oiDayChange;
		}
		public Double getHighestOptChainVol_oiDayChangePerc() {
			return highestOptChainVol_oiDayChangePerc;
		}
		public void setHighestOptChainVol_oiDayChangePerc(Double highestOptChainVol_oiDayChangePerc) {
			this.highestOptChainVol_oiDayChangePerc = highestOptChainVol_oiDayChangePerc;
		}
		public Long getHighestOptChainVol_lastTradeQty() {
			return highestOptChainVol_lastTradeQty;
		}
		public void setHighestOptChainVol_lastTradeQty(Long highestOptChainVol_lastTradeQty) {
			this.highestOptChainVol_lastTradeQty = highestOptChainVol_lastTradeQty;
		}
		public Long getHighestOptChainVol_lastTradeTime() {
			return highestOptChainVol_lastTradeTime;
		}
		public void setHighestOptChainVol_lastTradeTime(Long highestOptChainVol_lastTradeTime) {
			this.highestOptChainVol_lastTradeTime = highestOptChainVol_lastTradeTime;
		}
		public String getHighestOptChainVol_type() {
			return highestOptChainVol_type;
		}
		public void setHighestOptChainVol_type(String highestOptChainVol_type) {
			this.highestOptChainVol_type = highestOptChainVol_type;
		}
		public String getHighestOptChainVol_symbol() {
			return highestOptChainVol_symbol;
		}
		public void setHighestOptChainVol_symbol(String highestOptChainVol_symbol) {
			this.highestOptChainVol_symbol = highestOptChainVol_symbol;
		}
		public Long getHighestOptChainVol_tsInMillis() {
			return highestOptChainVol_tsInMillis;
		}
		public void setHighestOptChainVol_tsInMillis(Long highestOptChainVol_tsInMillis) {
			this.highestOptChainVol_tsInMillis = highestOptChainVol_tsInMillis;
		}
		public String getHighestOptChainVol_strikePrice() {
			return highestOptChainVol_strikePrice;
		}
		public void setHighestOptChainVol_strikePrice(String highestOptChainVol_strikePrice) {
		...
		public String toString() {
			return "BankNiftyCompaniesData [id=" + id + ", HDFCBANK_close=" + HDFCBANK_close + ", ICICIBANK_close="
					...
					+ ", IDFCFIRSTB_close=" + IDFCFIRSTB_close + ", AUBANK_close=" + AUBANK_close
					+ ", FEDERALBNK_close=" + FEDERALBNK_close + ", HDFCBANK_dayChange=" + HDFCBANK_dayChange
					+ ", ICICIBANK_dayChange=" + ICICIBANK_dayChange + ", SBIN_dayChange=" + SBIN_dayChange
					+ ", KOTAKBANK_dayChange=" + KOTAKBANK_dayChange + ", AXISBANK_dayChange=" + AXISBANK_dayChange
					+ ", PNB_dayChange=" + PNB_dayChange + ", BANKBARODA_dayChange=" + BANKBARODA_dayChange
					+ ", CANBK_dayChange=" + CANBK_dayChange + ", INDUSINDBK_dayChange=" + INDUSINDBK_dayChange
					+ ", IDFCFIRSTB_dayChange=" + IDFCFIRSTB_dayChange + ", AUBANK_dayChange=" + AUBANK_dayChange
					+ ", FEDERALBNK_dayChange=" + FEDERALBNK_dayChange + ", HDFCBANK_dayChangePerc="
					+ HDFCBANK_dayChangePerc + ", ICICIBANK_dayChangePerc=" + ICICIBANK_dayChangePerc
					+ ", SBIN_dayChangePerc=" + SBIN_dayChangePerc + ", KOTAKBANK_dayChangePerc="
					+ KOTAKBANK_dayChangePerc + ", AXISBANK_dayChangePerc=" + AXISBANK_dayChangePerc
					+ ", PNB_dayChangePerc=" + PNB_dayChangePerc + ", BANKBARODA_dayChangePerc="
					...
					+ KOTAKBANK_high + ", AXISBANK_high=" + AXISBANK_high + ", PNB_high=" + PNB_high
					+ ", BANKBARODA_high=" + BANKBARODA_high + ", CANBK_high=" + CANBK_high + ", INDUSINDBK_high="
					+ INDUSINDBK_high + ", IDFCFIRSTB_high=" + IDFCFIRSTB_high + ", AUBANK_high=" + AUBANK_high
					+ ", FEDERALBNK_high=" + FEDERALBNK_high + ", HDFCBANK_highPriceRange=" + HDFCBANK_highPriceRange
					...
					+ ", AXISBANK_highPriceRange=" + AXISBANK_highPriceRange + ", PNB_highPriceRange="
					+ PNB_highPriceRange + ", BANKBARODA_highPriceRange=" + BANKBARODA_highPriceRange
					+ ", CANBK_highPriceRange=" + CANBK_highPriceRange + ", INDUSINDBK_highPriceRange="
					+ INDUSINDBK_highPriceRange + ", IDFCFIRSTB_highPriceRange=" + IDFCFIRSTB_highPriceRange
					+ ", AUBANK_highPriceRange=" + AUBANK_highPriceRange + ", FEDERALBNK_highPriceRange="
					+ FEDERALBNK_highPriceRange + ", HDFCBANK_highTradeRange=" + HDFCBANK_highTradeRange
					+ ", ICICIBANK_highTradeRange=" + ICICIBANK_highTradeRange + ", SBIN_highTradeRange="
					+ SBIN_highTradeRange + ", KOTAKBANK_highTradeRange=" + KOTAKBANK_highTradeRange
					+ ", AXISBANK_highTradeRange=" + AXISBANK_highTradeRange + ", PNB_highTradeRange="
					+ PNB_highTradeRange + ", BANKBARODA_highTradeRange=" + BANKBARODA_highTradeRange
					+ ", CANBK_highTradeRange=" + CANBK_highTradeRange + ", INDUSINDBK_highTradeRange="
					+ INDUSINDBK_highTradeRange + ", IDFCFIRSTB_highTradeRange=" + IDFCFIRSTB_highTradeRange
					+ ", AUBANK_highTradeRange=" + AUBANK_highTradeRange + ", FEDERALBNK_highTradeRange="
					+ FEDERALBNK_highTradeRange + ", HDFCBANK_lastTradeQty=" + HDFCBANK_lastTradeQty
					+ ", ICICIBANK_lastTradeQty=" + ICICIBANK_lastTradeQty + ", SBIN_lastTradeQty=" + SBIN_lastTradeQty
					+ ", KOTAKBANK_lastTradeQty=" + KOTAKBANK_lastTradeQty + ", AXISBANK_lastTradeQty="
					+ AXISBANK_lastTradeQty + ", PNB_lastTradeQty=" + PNB_lastTradeQty + ", BANKBARODA_lastTradeQty="
					+ BANKBARODA_lastTradeQty + ", CANBK_lastTradeQty=" + CANBK_lastTradeQty
					+ ", INDUSINDBK_lastTradeQty=" + INDUSINDBK_lastTradeQty + ", IDFCFIRSTB_lastTradeQty="
					+ IDFCFIRSTB_lastTradeQty + ", AUBANK_lastTradeQty=" + AUBANK_lastTradeQty
					+ ", FEDERALBNK_lastTradeQty=" + FEDERALBNK_lastTradeQty + ", HDFCBANK_lastTradeTime="
					+ HDFCBANK_lastTradeTime + ", ICICIBANK_lastTradeTime=" + ICICIBANK_lastTradeTime
					+ ", SBIN_lastTradeTime=" + SBIN_lastTradeTime + ", KOTAKBANK_lastTradeTime="
					+ KOTAKBANK_lastTradeTime + ", AXISBANK_lastTradeTime=" + AXISBANK_lastTradeTime
					+ ", PNB_lastTradeTime=" + PNB_lastTradeTime + ", BANKBARODA_lastTradeTime="
					+ BANKBARODA_lastTradeTime + ", CANBK_lastTradeTime=" + CANBK_lastTradeTime
					+ ", INDUSINDBK_lastTradeTime=" + INDUSINDBK_lastTradeTime + ", IDFCFIRSTB_lastTradeTime="
					+ IDFCFIRSTB_lastTradeTime + ", AUBANK_lastTradeTime=" + AUBANK_lastTradeTime
					+ ", FEDERALBNK_lastTradeTime=" + FEDERALBNK_lastTradeTime + ", HDFCBANK_low=" + HDFCBANK_low
					+ ", ICICIBANK_low=" + ICICIBANK_low + ", SBIN_low=" + SBIN_low + ", KOTAKBANK_low=" + KOTAKBANK_low
					+ ", AXISBANK_low=" + AXISBANK_low + ", PNB_low=" + PNB_low + ", BANKBARODA_low=" + BANKBARODA_low
					+ ", CANBK_low=" + CANBK_low + ", INDUSINDBK_low=" + INDUSINDBK_low + ", IDFCFIRSTB_low="
					+ IDFCFIRSTB_low + ", AUBANK_low=" + AUBANK_low + ", FEDERALBNK_low=" + FEDERALBNK_low
					+ ", HDFCBANK_lowPriceRange=" + HDFCBANK_lowPriceRange + ", ICICIBANK_lowPriceRange="
					+ ICICIBANK_lowPriceRange + ", SBIN_lowPriceRange=" + SBIN_lowPriceRange
					+ ", KOTAKBANK_lowPriceRange=" + KOTAKBANK_lowPriceRange + ", AXISBANK_lowPriceRange="
					+ AXISBANK_lowPriceRange + ", PNB_lowPriceRange=" + PNB_lowPriceRange
					...
					+ ICICIBANK_lowTradeRange + ", SBIN_lowTradeRange=" + SBIN_lowTradeRange
					+ ", KOTAKBANK_lowTradeRange=" + KOTAKBANK_lowTradeRange + ", AXISBANK_lowTradeRange="
					+ AXISBANK_lowTradeRange + ", PNB_lowTradeRange=" + PNB_lowTradeRange
					+ ", BANKBARODA_lowTradeRange=" + BANKBARODA_lowTradeRange + ", CANBK_lowTradeRange="
					+ CANBK_lowTradeRange + ", INDUSINDBK_lowTradeRange=" + INDUSINDBK_lowTradeRange
					+ ", IDFCFIRSTB_lowTradeRange=" + IDFCFIRSTB_lowTradeRange + ", AUBANK_lowTradeRange="
					+ AUBANK_lowTradeRange + ", FEDERALBNK_lowTradeRange=" + FEDERALBNK_lowTradeRange
					+ ", HDFCBANK_ltp=" + HDFCBANK_ltp + ", ICICIBANK_ltp=" + ICICIBANK_ltp + ", SBIN_ltp=" + SBIN_ltp
					+ ", KOTAKBANK_ltp=" + KOTAKBANK_ltp + ", AXISBANK_ltp=" + AXISBANK_ltp + ", PNB_ltp=" + PNB_ltp
					+ ", BANKBARODA_ltp=" + BANKBARODA_ltp + ", CANBK_ltp=" + CANBK_ltp + ", INDUSINDBK_ltp="
					+ INDUSINDBK_ltp + ", IDFCFIRSTB_ltp=" + IDFCFIRSTB_ltp + ", AUBANK_ltp=" + AUBANK_ltp
					+ ", FEDERALBNK_ltp=" + FEDERALBNK_ltp + ", HDFCBANK_oiDayChange=" + HDFCBANK_oiDayChange
					+ ", ICICIBANK_oiDayChange=" + ICICIBANK_oiDayChange + ", SBIN_oiDayChange=" + SBIN_oiDayChange
					+ ", KOTAKBANK_oiDayChange=" + KOTAKBANK_oiDayChange + ", AXISBANK_oiDayChange="
					+ AXISBANK_oiDayChange + ", PNB_oiDayChange=" + PNB_oiDayChange + ", BANKBARODA_oiDayChange="
					+ BANKBARODA_oiDayChange + ", CANBK_oiDayChange=" + CANBK_oiDayChange + ", INDUSINDBK_oiDayChange="
					+ INDUSINDBK_oiDayChange + ", IDFCFIRSTB_oiDayChange=" + IDFCFIRSTB_oiDayChange
					+ ", AUBANK_oiDayChange=" + AUBANK_oiDayChange + ", FEDERALBNK_oiDayChange="
					+ FEDERALBNK_oiDayChange + ", HDFCBANK_oiDayChangePerc=" + HDFCBANK_oiDayChangePerc
					+ ", ICICIBANK_oiDayChangePerc=" + ICICIBANK_oiDayChangePerc + ", SBIN_oiDayChangePerc="
					+ SBIN_oiDayChangePerc + ", KOTAKBANK_oiDayChangePerc=" + KOTAKBANK_oiDayChangePerc
					+ ", AXISBANK_oiDayChangePerc=" + AXISBANK_oiDayChangePerc + ", PNB_oiDayChangePerc="
					+ PNB_oiDayChangePerc + ", BANKBARODA_oiDayChangePerc=" + BANKBARODA_oiDayChangePerc
					+ ", CANBK_oiDayChangePerc=" + CANBK_oiDayChangePerc + ", INDUSINDBK_oiDayChangePerc="
					+ INDUSINDBK_oiDayChangePerc + ", IDFCFIRSTB_oiDayChangePerc=" + IDFCFIRSTB_oiDayChangePerc
					+ ", AUBANK_oiDayChangePerc=" + AUBANK_oiDayChangePerc + ", FEDERALBNK_oiDayChangePerc="
					+ FEDERALBNK_oiDayChangePerc + ", HDFCBANK_open=" + HDFCBANK_open + ", ICICIBANK_open="
					+ ICICIBANK_open + ", SBIN_open=" + SBIN_open + ", KOTAKBANK_open=" + KOTAKBANK_open
					+ ", AXISBANK_open=" + AXISBANK_open + ", PNB_open=" + PNB_open + ", BANKBARODA_open="
					...
					+ KOTAKBANK_openInterest + ", AXISBANK_openInterest=" + AXISBANK_openInterest
					+ ", PNB_openInterest=" + PNB_openInterest + ", BANKBARODA_openInterest=" + BANKBARODA_openInterest
					+ ", CANBK_openInterest=" + CANBK_openInterest + ", INDUSINDBK_openInterest="
					+ INDUSINDBK_openInterest + ", IDFCFIRSTB_openInterest=" + IDFCFIRSTB_openInterest
					+ ", AUBANK_openInterest=" + AUBANK_openInterest + ", FEDERALBNK_openInterest="
					+ FEDERALBNK_openInterest + ", HDFCBANK_prevOpenInterest=" + HDFCBANK_prevOpenInterest
					+ ", ICICIBANK_prevOpenInterest=" + ICICIBANK_prevOpenInterest + ", SBIN_prevOpenInterest="
					+ SBIN_prevOpenInterest + ", KOTAKBANK_prevOpenInterest=" + KOTAKBANK_prevOpenInterest
					+ ", AXISBANK_prevOpenInterest=" + AXISBANK_prevOpenInterest + ", PNB_prevOpenInterest="
					+ PNB_prevOpenInterest + ", BANKBARODA_prevOpenInterest=" + BANKBARODA_prevOpenInterest
					+ ", CANBK_prevOpenInterest=" + CANBK_prevOpenInterest + ", INDUSINDBK_prevOpenInterest="
					+ INDUSINDBK_prevOpenInterest + ", IDFCFIRSTB_prevOpenInterest=" + IDFCFIRSTB_prevOpenInterest
					+ ", AUBANK_prevOpenInterest=" + AUBANK_prevOpenInterest + ", FEDERALBNK_prevOpenInterest="
					+ FEDERALBNK_prevOpenInterest + ", HDFCBANK_symbol=" + HDFCBANK_symbol + ", ICICIBANK_symbol="
					+ ICICIBANK_symbol + ", SBIN_symbol=" + SBIN_symbol + ", KOTAKBANK_symbol=" + KOTAKBANK_symbol
					+ ", AXISBANK_symbol=" + AXISBANK_symbol + ", PNB_symbol=" + PNB_symbol + ", BANKBARODA_symbol="
					+ BANKBARODA_symbol + ", CANBK_symbol=" + CANBK_symbol + ", INDUSINDBK_symbol=" + INDUSINDBK_symbol
					+ ", IDFCFIRSTB_symbol=" + IDFCFIRSTB_symbol + ", AUBANK_symbol=" + AUBANK_symbol
					+ ", FEDERALBNK_symbol=" + FEDERALBNK_symbol + ", HDFCBANK_totalBuyQty=" + HDFCBANK_totalBuyQty
					+ ", ICICIBANK_totalBuyQty=" + ICICIBANK_totalBuyQty + ", SBIN_totalBuyQty=" + SBIN_totalBuyQty
					+ ", KOTAKBANK_totalBuyQty=" + KOTAKBANK_totalBuyQty + ", AXISBANK_totalBuyQty="
					+ AXISBANK_totalBuyQty + ", PNB_totalBuyQty=" + PNB_totalBuyQty + ", BANKBARODA_totalBuyQty="
					+ BANKBARODA_totalBuyQty + ", CANBK_totalBuyQty=" + CANBK_totalBuyQty + ", INDUSINDBK_totalBuyQty="
					+ INDUSINDBK_totalBuyQty + ", IDFCFIRSTB_totalBuyQty=" + IDFCFIRSTB_totalBuyQty
					+ ", AUBANK_totalBuyQty=" + AUBANK_totalBuyQty + ", FEDERALBNK_totalBuyQty="
					...
					+ BANKBARODA_totalSellQty + ", CANBK_totalSellQty=" + CANBK_totalSellQty
					+ ", INDUSINDBK_totalSellQty=" + INDUSINDBK_totalSellQty + ", IDFCFIRSTB_totalSellQty="
					+ IDFCFIRSTB_totalSellQty + ", AUBANK_totalSellQty=" + AUBANK_totalSellQty
					+ ", FEDERALBNK_totalSellQty=" + FEDERALBNK_totalSellQty + ", HDFCBANK_tsInMillis="
					+ HDFCBANK_tsInMillis + ", ICICIBANK_tsInMillis=" + ICICIBANK_tsInMillis + ", SBIN_tsInMillis="
					+ SBIN_tsInMillis + ", KOTAKBANK_tsInMillis=" + KOTAKBANK_tsInMillis + ", AXISBANK_tsInMillis="
					+ AXISBANK_tsInMillis + ", PNB_tsInMillis=" + PNB_tsInMillis + ", BANKBARODA_tsInMillis="
					+ BANKBARODA_tsInMillis + ", CANBK_tsInMillis=" + CANBK_tsInMillis + ", INDUSINDBK_tsInMillis="
					+ INDUSINDBK_tsInMillis + ", IDFCFIRSTB_tsInMillis=" + IDFCFIRSTB_tsInMillis
					+ ", AUBANK_tsInMillis=" + AUBANK_tsInMillis + ", FEDERALBNK_tsInMillis=" + FEDERALBNK_tsInMillis
					+ ", HDFCBANK_volume=" + HDFCBANK_volume + ", ICICIBANK_volume=" + ICICIBANK_volume
					+ ", SBIN_volume=" + SBIN_volume + ", KOTAKBANK_volume=" + KOTAKBANK_volume + ", AXISBANK_volume="
					+ AXISBANK_volume + ", PNB_volume=" + PNB_volume + ", BANKBARODA_volume=" + BANKBARODA_volume
					+ ", CANBK_volume=" + CANBK_volume + ", INDUSINDBK_volume=" + INDUSINDBK_volume
					...
					+ ", ICICIBANK_yearHighPrice=" + ICICIBANK_yearHighPrice + ", SBIN_yearHighPrice="
					+ SBIN_yearHighPrice + ", KOTAKBANK_yearHighPrice=" + KOTAKBANK_yearHighPrice
					+ ", AXISBANK_yearHighPrice=" + AXISBANK_yearHighPrice + ", PNB_yearHighPrice=" + PNB_yearHighPrice
					+ ", BANKBARODA_yearHighPrice=" + BANKBARODA_yearHighPrice + ", CANBK_yearHighPrice="
					+ CANBK_yearHighPrice + ", INDUSINDBK_yearHighPrice=" + INDUSINDBK_yearHighPrice
					+ ", IDFCFIRSTB_yearHighPrice=" + IDFCFIRSTB_yearHighPrice + ", AUBANK_yearHighPrice="
					+ AUBANK_yearHighPrice + ", FEDERALBNK_yearHighPrice=" + FEDERALBNK_yearHighPrice
					+ ", HDFCBANK_yearLowPrice=" + HDFCBANK_yearLowPrice + ", ICICIBANK_yearLowPrice="
					+ ICICIBANK_yearLowPrice + ", SBIN_yearLowPrice=" + SBIN_yearLowPrice + ", KOTAKBANK_yearLowPrice="
					+ KOTAKBANK_yearLowPrice + ", AXISBANK_yearLowPrice=" + AXISBANK_yearLowPrice
					+ ", PNB_yearLowPrice=" + PNB_yearLowPrice + ", BANKBARODA_yearLowPrice=" + BANKBARODA_yearLowPrice
					+ ", CANBK_yearLowPrice=" + CANBK_yearLowPrice + ", INDUSINDBK_yearLowPrice="
					...
					+ FEDERALBNK_yearLowPrice + ", HDFCBANK_type=" + HDFCBANK_type + ", ICICIBANK_type="
					+ ICICIBANK_type + ", SBIN_type=" + SBIN_type + ", KOTAKBANK_type=" + KOTAKBANK_type
					+ ", AXISBANK_type=" + AXISBANK_type + ", PNB_type=" + PNB_type + ", BANKBARODA_type="
					+ BANKBARODA_type + ", CANBK_type=" + CANBK_type + ", INDUSINDBK_type=" + INDUSINDBK_type
					+ ", IDFCFIRSTB_type=" + IDFCFIRSTB_type + ", AUBANK_type=" + AUBANK_type + ", FEDERALBNK_type="
	 ...
	 public static synchronized BankNiftyCompaniesData getInstance() {
	        if (instance == null) {
	            instance = new BankNiftyCompaniesData();
	        }
	        return instance;
	    }
	}
